...
let headCoach = "Alex Ferguson";
let headCoachAge = 78;
let currentClub = "Manchester FC";
let trophiesWonCount = 27;

//Write your function here
function createManagerArray(headCoach, headCoachAge, currentClub, trophiesWonCount){
  var ManagerArray = [headCoach, headCoachAge, currentClub, trophiesWonCount];
  return ManagerArray;
}

// Don't edit the following code
try {
  var manager = createManagerArray(
    headCoach,
    headCoachAge,
    currentClub,
    trophiesWonCount
...
//write your function here
function createFormationObject(formationArray){
  if(formationArray.length==0){
    return null;
  }
  var playFormation = {
    defenders: formationArray[0],
    midfielders: formationArray[1],
    forwards: formationArray[2]
  }
...
try {
  var formationObject = createFormationObject(formationArray);
} catch (e) {
  //do nothing
}
...
function SortByNamexAwardsxTimes(awardName, noOfTimes, country){
  var dataOne = filterByAwardsxTimes(awardName, noOfTimes);
